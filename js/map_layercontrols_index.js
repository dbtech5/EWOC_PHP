...
function geojson_vt(ilayer, ilayerfile, ilayerobject, ifillcolor, istrokecolor, istrokewidth, ilinedash,ilabel, izIndex, maxres) {
    ...
    fetch(url).then(function (response) {
        ...
        console.log(Object.keys(json.objects))

        if(Object.keys(json.objects)[0] != ilayerobject){
        ...
        }else if (ilayer == 'Pipe_Klongluang') {
            layers[ilayer].setStyle([
                // border
                new ol.style.Style({
                    stroke: new ol.style.Stroke({
...
function topojson_label(ilayer, ilayerfile, ifont, itextfillcolor, itextstrokecolor, itextstrokewidth, ifillcolor, istrokecolor, istrokewidth, ilinedash, ilabel, displayText=true,iscale = 12, maxres) {
    ...
    let scale = 12/10.5
    try{
        display = document.getElementById('text-'+ilayer).checked
        scale = document.getElementById('size-'+ilayer).innerHTML/10.5
    }catch(err){
...
=======
                        anchor: [0.5+0.3, 1.4],
                        opacity: 1,
>>>>>>> 90cb158fe147d3c5ecbfda4cc5885f34fe9c3a7f
                        src: iconfile,
                        // mapsize/imagesize
                        scale: iconscale
                    })),
