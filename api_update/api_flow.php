<?php
	// Sets default timezone for Asia.
	date_default_timezone_set("Asia/Bangkok");
	set_time_limit(10000);
	ini_set('memory_limit', '514M');
	...
	// Authenticate today from Hydro6
	echo "<br><b>update ".$m_e[0]."</b><br>";
	...
	CURLOPT_POSTFIELDS => "{\"hydro\":{\"hydroid\":\"6\" , \"TimeStart\" : \"".$m_e[0]."\"}}",
